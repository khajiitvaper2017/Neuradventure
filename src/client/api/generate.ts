...
import { StoryModulesSchema } from "../engine/schemas/story-modules.js"
import { createOrGetSession, publishComplete, publishError, publishPreview } from "../engine/streaming/hub.js"
import { generateCharacter, generateCharacterPart, generateChat, generateStory } from "../engine/llm/index.js"
import type {
...
import type { MainCharacterState, StoryModules } from "../../../shared/types.js"
...
function asGenerateError(err: unknown): ApiError {
  ...
  return new ApiError(500, message || "Generation failed")
}
...
export const generate = {
  ...
  > => {
    ...
    if ((part === "appearance" || part === "clothing") && !safeModules.character_appearance_clothing) {
      throw new ApiError(400, "Appearance/clothing generation is disabled by story modules.")
    }
    if (
      part === "traits" &&
      ...
      throw new ApiError(400, "Character trait generation is disabled by story modules.")
    }
